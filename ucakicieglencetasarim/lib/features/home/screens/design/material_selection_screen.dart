...
class _MaterialSelectionScreenState extends State<MaterialSelectionScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _steps = [
    {
      ...
      'description': 'Malzeme özelliklerini araştır',
      'icon': Icons.science,
      'details': [
        'Hafiflik ve dayanıklılık',
        'Isı ve korozyon direnci',
        'Maliyet ve bulunabilirlik',
        'İşlenebilirlik özellikleri'
      ],
      'image': 'assets/images/material_properties.png'
    },
    {
      'title': 'Maliyet Analizi',
      'description': 'Maliyet analizi yap',
      'icon': Icons.attach_money,
      'details': [
        'Malzeme maliyetleri',
        'İşçilik maliyetleri',
        'Bakım maliyetleri',
        'Toplam maliyet projeksiyonu'
      ],
      'image': 'assets/images/cost_analysis.png'
    },
    {
      'title': 'Dayanıklılık Testleri',
      'description': 'Dayanıklılık testlerini planla',
      ...
      'image': 'assets/images/durability_tests.png'
    },
    {
      'title': 'Malzeme Kombinasyonları',
      'description': 'Malzeme kombinasyonlarını değerlendir',
      'icon': Icons.architecture,
      'details': [
        'Kompozit malzemeler',
        'Hibrit yapılar',
        'Bağlantı noktaları',
        'Final malzeme seçimi'
      ],
      'image': 'assets/images/material_combinations.png'
    }
  ];
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Malzeme Seçimi Rozeti Kazandın!',
